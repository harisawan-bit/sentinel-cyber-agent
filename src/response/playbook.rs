...
async fn exfiltration_playbook(target: &str) -> Result<()> {
    tracing::error!(target = target, "Data exfiltration detected - Executing playbook");
...
async fn container_escape_playbook(target: &str) -> Result<()> {
    tracing::error!(target = target, "Container escape detected - Executing playbook");
...
async fn privilege_escalation_playbook(target: &str) -> Result<()> {
    tracing::error!(target = target, "Privilege escalation detected - Executing playbook");
